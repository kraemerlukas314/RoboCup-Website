...
function updatePoints(){
    ...
    let points_linefollowing = (gaps*10) + (intersections*10) + (speed_bumps*10) + (ramps*10) + (seesaws*20) + (obstacles*20) // points for gaps, speed bumps, obstacles, intersections etc.

    let multiplier = 1;
    let multiplier_ded_lop_evac = Math.min(lops_evac, 3) * EVAC_LOP_MULTIPLIER;
